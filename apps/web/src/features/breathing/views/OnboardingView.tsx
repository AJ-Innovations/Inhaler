...
export function OnboardingView({ onComplete }: OnboardingViewProps) {
  ...
  const goals = [
    { id: 'sleep', title: 'Deep Sleep & Insomnia Cure', desc: 'Fall asleep faster and maximize recovery.', icon: Moon, color: 'text-indigo-400' },
    { id: 'stress', title: 'Anxiety & Quick Stress Relief', desc: 'Settle your nervous system in 2 minutes.', icon: Zap, color: 'text-orange-400' },
    { id: 'focus', title: 'Extreme Focus & Brain Clarity', desc: 'Navy SEAL method to lock in attention.', icon: Brain, color: 'text-blue-400' },
    { id: 'power', title: 'Athletic Grit & Endurance', desc: 'Expand CO2 tolerance and lung volume.', icon: Wind, color: 'text-emerald-400' }
  ];
  ...
  return (
    <div className="fixed inset-0 bg-black z-[500] text-white flex flex-col font-sans select-none overflow-hidden max-w-[480px] mx-auto w-full border-x border-white/[0.04] shadow-2xl">
      <div className="flex-1 flex flex-col justify-center px-6 relative z-10 py-10 h-full overflow-y-auto">
        <AnimatePresence mode="wait">
          ...
          {step === 'intro' && (
            ...
            >
              ...
              <button
                ...
                className="w-full h-14 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-[0_20px_40px_rgba(255,255,255,0.06)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 mt-8 relative overflow-hidden"
              >
          ...
          {step === 'q_goal' && (
            ...
            >
              <div className="space-y-2">
                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-400">Step 1 of 3</span>
                <h2 className="text-3xl font-light text-white tracking-tight leading-tight">What is your primary goal today?</h2>
                <p className="text-gray-500 text-xs font-light">We will tailor your initial sessions based on this choice.</p>
              </div>
              ...
              <div className="space-y-3">
                {goals.map((g) => (
                  <button
                    ...
                    className={`w-full p-5 rounded-2xl border text-left flex items-center gap-4 transition-all duration-300 ${
                      selectedGoal === g.id 
                        ? 'border-emerald-500/50 bg-emerald-500/5 shadow-[0_0_20px_rgba(16,185,129,0.06)] scale-[1.02]' 
                        : 'border-white/5 bg-white/[0.02] hover:border-white/10 hover:bg-white/[0.04]'
                    }`}
                  >
                    <div className={`p-3 rounded-xl bg-white/5 shrink-0 ${g.color}`}>
                      <g.icon size={20} />
                    </div>
                    <div className="space-y-1">
                      <h4 className="text-sm font-semibold text-white leading-none">{g.title}</h4>
                      <p className="text-[11px] text-gray-500 font-light">{g.desc}</p>
                    </div>
                  </button>
                ))}
              </div>
          ...
          {step === 'q_stress' && (
            ...
            >
              <div className="space-y-2">
                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-400">Step 2 of 3</span>
                <h2 className="text-3xl font-light text-white tracking-tight leading-tight">How often do you feel overwhelmed?</h2>
                <p className="text-gray-500 text-xs font-light">Helps customize routine reminders and heart-rate recovery cycles.</p>
              </div>
              ...
              <div className="space-y-3">
                {stressLevels.map((s) => (
                  ...
                  >
                    <div className="space-y-1">
                      <h4 className="text-sm font-semibold text-white leading-none">{s.title}</h4>
                      <p className="text-[11px] text-gray-500 font-light mt-1">{s.desc}</p>
                    </div>
                  </button>
                ))}
              </div>
          ...
          {step === 'q_experience' && (
            ...
            >
              <div className="space-y-2">
                <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-400">Step 3 of 3</span>
                <h2 className="text-3xl font-light text-white tracking-tight leading-tight">What is your experience level?</h2>
                <p className="text-gray-500 text-xs font-light">Determines inhale/hold intervals and unlocking advanced options.</p>
              </div>
              ...
              <div className="space-y-3">
                {experienceLevels.map((e) => (
                  ...
                  >
                    <div className="space-y-1">
                      <h4 className="text-sm font-semibold text-white leading-none">{e.title}</h4>
                      <p className="text-[11px] text-gray-500 font-light mt-1">{e.desc}</p>
                    </div>
                  </button>
                ))}
              </div>
          ...
          {step === 'calibrating' && (
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-500 text-xs font-light max-w-[280px] mx-auto leading-relaxed h-10 transition-all duration-300">
                  {calibrationText}
                </p>
              </div>
            </motion.div>
          ...
          {step === 'paywall' && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -30 }}
              className="absolute inset-0 z-50 bg-black flex flex-col h-full overflow-hidden"
            >
              <SubscriptionView
          ...
          {step === 'payment' && (
            ...
            >
              ...
              <div className="relative w-full h-44 rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.01] p-6 flex flex-col justify-between overflow-hidden shadow-2xl backdrop-blur-xl shrink-0">
                ...
                {/* Accent glow on card */}
                <div className={`absolute -right-20 -bottom-20 w-40 h-40 rounded-full blur-[60px] pointer-events-none opacity-40 ${
              ...
              <form onSubmit={handlePaymentSubmit} className="space-y-4">
                <div className="space-y-3">
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full h-12 bg-white/[0.03] border border-white/10 rounded-2xl pl-14 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/50 focus:bg-white/[0.05] transition-all font-light text-sm"
                      required
                    />
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className="w-full h-12 bg-white/[0.03] border border-white/10 rounded-2xl pl-14 pr-4 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/50 focus:bg-white/[0.05] transition-all font-mono text-sm"
                      required
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="relative group">
                      <input 
                        ...
                        className="w-full h-12 bg-white/[0.03] border border-white/10 rounded-2xl px-5 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/50 focus:bg-white/[0.05] transition-all font-mono text-sm text-center"
                        maxLength={5}
                        required
                      />
                    </div>
                ...
                <button
                  type="submit"
                  disabled={isPaying}
                  className="w-full h-14 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-emerald-400 transition-all shadow-2xl active:scale-95 flex items-center justify-center gap-3 relative overflow-hidden"
                >
          ...
          {step === 'success' && (
            ...
            >
              ...
              <button
                ...
                className="w-full h-14 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 mt-8"
              >
      ...
      <div className="fixed -top-40 -left-40 w-96 h-96 bg-emerald-500/5 blur-[120px] rounded-full pointer-events-none" />
      <div className="fixed -bottom-40 -right-40 w-96 h-96 bg-indigo-500/5 blur-[120px] rounded-full pointer-events-none" />
    </div>
  );
}
