...
export function SocialAuth() {
  return (
    <div className="grid grid-cols-2 gap-3">
      <button className="group flex h-14 items-center justify-center gap-3 rounded-full border border-white/10 bg-white/[0.03] text-gray-200 transition-all hover:bg-white/5 hover:text-white active:scale-95">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
        ...
        <span className="text-[9px] font-black tracking-widest text-gray-200 uppercase transition-colors group-hover:text-white">
          Google
        </span>
      </button>
      <button className="group flex h-14 items-center justify-center gap-3 rounded-full border border-white/10 bg-white/[0.03] text-gray-200 transition-all hover:bg-white/5 hover:text-white active:scale-95">
